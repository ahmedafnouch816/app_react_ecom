...
function Detail() {
    ...
    const handleCreateCommentSubmit = async (event) => {
        ...
        const resposne = await apiInstance.post(`post/comment-post/`, json);
                    ...
                    <div className="row">
                        <div className="col-lg-2">
                            <div className="text-start text-lg-center mb-5" data-sticky="" data-margin-top={80} data-sticky-for={991}>
                                ...
                                <button onClick={handleBookMarkPost} className="btn btn-danger ms-4">
